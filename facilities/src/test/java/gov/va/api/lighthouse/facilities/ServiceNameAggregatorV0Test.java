...
import static gov.va.api.lighthouse.facilities.api.v0.Facility.BenefitsService.Pensions;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.Audiology;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.Cardiology;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.Covid19Vaccine;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.EmergencyCare;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.PrimaryCare;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.HealthService.WomensHealth;
import static gov.va.api.lighthouse.facilities.api.v0.Facility.OtherService.OnlineScheduling;
...
public class ServiceNameAggregatorV0Test {
  ...
  @Test
  void serviceName() {
    ServiceNameAggregatorV0 serviceNameAggregator =
        new ServiceNameAggregatorV0(mockAccessToCareMapper, mockCmsOverlayMapper);
    ...
    // CMS service name expected to be displayed for Covid-19
    assertThat(serviceNameAggregate.serviceName(Covid19Vaccine.serviceId()))
        .isEqualTo("COVID-19 vaccines");
    // Service absent from ATC. Service enum name expected to be displayed
    ...
    assertThat(serviceNameAggregate.serviceName(capitalize(EmergencyCare.serviceId())))
        .isEqualTo(EmergencyCare.name());
    // Service present in both CMS and ATC. ATC service name expected to be displayed
